...
func (p *kClient) UploadFile(ctx context.Context, req *file.UploadRequest) (r *file.UploadResponse, err error) {
...
func (p *kClient) DownloadFile(ctx context.Context, req *file.DownloadRequest) (r *file.DownloadResponse, err error) {
